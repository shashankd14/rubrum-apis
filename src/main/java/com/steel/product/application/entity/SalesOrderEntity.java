...
public class SalesOrderEntity {
	...
	public Set<SalesOrderPacketsEntity> getInstructions() {
		return instructions;
	}

	public void setInstructions(Set<SalesOrderPacketsEntity> instruction) {
	...
	public static InwardEntryResponseDto valueOfResponse(InwardEntry inwardEntry) {
		...
		inwardEntryResponseDto.setInstruction(inwardEntry.getInstructions() != null ?
				inwardEntry.getInstructions().stream().filter(i -> !i.getIsDeleted())
						.map(i -> SalesOrderPacketsEntity.valueOf(i)).collect(Collectors.toList()): null);
