...
public class SalesOrderPacketsEntity {
	...
	private SalesOrderEntity inwardId;
	...
	private Set<SalesOrderPacketsEntity> childInstructions;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "parentinstructionid", referencedColumnName = "instructionid")
	private SalesOrderPacketsEntity parentInstruction;
    ...
    public void addChildInstruction(SalesOrderPacketsEntity instruction) {
